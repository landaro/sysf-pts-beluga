...
\newcommand{\tfF}{\tsAnnot{\SysF}{\ty}}  % for type formation judgement
\newcommand{\tyF}{\tsAnnot{\SysF}{\tm}}  % for typing judgement
...
\begin{mathpar}
  \inferrule*{~}{\mathbf{wf}_{\SysF}\;\;\cc{\emptyset}{\emptyctx}} \and
  \inferrule*[right=$X \notin \Delta$]{\mathbf{wf}_{\SysF}\;\;\cc{\Delta}{\emptyctx}}{\mathbf{wf}_{\SysF}\;\;\cc{\Delta,X}{\emptyctx}} \and
  \inferrule*[right=$x \notin \dom{\Gamma}$]{\mathbf{wf}_{\SysF}\;\;\cc{\Delta}{\Gamma} \\ \istyF{\Delta}{A}}{\mathbf{wf}_{\SysF}\;\;\cc{\Delta}{\Gamma, x \of A}}
\end{mathpar}
...
\begin{figure}
  \begin{center}
    ...
    \end{mathpar}
  \end{center}
  \caption{System~\SysF{} -- de Bruijn encoding in Coq.}
  \label{fig:sys-f-coq}
\end{figure}
...
\begin{figure}
  \begin{center}
    ...
    \end{mathpar}
  \end{center}
  \caption{HOAS specification of \SysF in Abella.}
...
\begin{mathpar}
  ...
  \inferrule*{\acR{L_{\SysF}}{L_{\tmr}}{L_{\lambda}} \\ x, y \notin L_{i}}{\acR{L_{\SysF}, \istyFh{x}}{L_{\tmr}, x \tyr y}{L_{\lambda}, \typingLh{y}{\Prp}}} \and
  \inferrule*{\acR{L_{\SysF}}{L_{\tmr}}{L_{\lambda}} \\ x, y \notin L_{i},A,a \\\\ \{L_{\SysF} \vdash \istyFh{A}\} \\ \{ L_{\tmr} \vdash A \tyr a \} \\ \{L_{\lambda} \vdash \typingLh{a}{\Prp}\}}{\acR{L_{\SysF}, \typingFh{x}{A}}{L_{\tmr}, x \tmr y}{L_{\lambda}, \typingLh{y}{a}}}
\end{mathpar}
