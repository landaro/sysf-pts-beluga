...
% JK: not sure what the purpose of this is, as it doesn't appear to affect the document length
% by a single line ....
% there are the \mprset commands in each mathpar environment that allow to tune the various spaces.
%\makeatletter
...
\begin{figure}
  \begin{center}
    \begin{mathpar}
      ...
      \inferrule*[right=t\_pi]{\typingLh{a}{\Prod{c}{d}} \\ \typingLh{b}{c}}{\typingLh{a\,b}{\lpApp{d}{b}}} \and
      \inferrule*[right=t\_lam]{\typingLh{a}{s} \\ \sortLh{s} \\\\ \lpPi x \typingLh{x}{a} \lpImp \typingLh{\lpApp{b}{x}}{\Prp}}{\typingLh{\Prod{a}{b}}{\Prp}} \and
      \inferrule*[right=t\_app]{\typingLh{a}{s} \\ \sortLh{s} \\  \lpPi x \typingLh{x}{a} \lpImp \typingLh{\lpApp{c}{x}}{\Prp} \\ \lpPi x \typingLh{x}{a} \lpImp \typingLh{\lpApp{b}{x}}{\lpApp{c}{x}}}{\typingLh{\Lam{a}{b}}{\Prod{a}{c}}}
    \end{mathpar}
  \end{center}
...
\begin{mathpar}
  ...
  \inferrule*{\acR{L_{F}}{L_{\tmr}}{L_{\lambda}} \\ \{L_{F} \vdash \istyFh{A}\} \\ \{ L_{\tmr} \vdash A \tyr a \} \\ \{L_{\lambda} \vdash \typingLh{a}{\Prp}\} \\ x, y \notin L_{i},A,a}{\acR{L_{F}, \typingFh{x}{A}}{L_{\tmr}, x \tmr y}{L_{\lambda}, \typingLh{y}{a}}}
\end{mathpar}
